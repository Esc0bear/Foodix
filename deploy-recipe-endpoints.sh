...
# 🍳 Script de déploiement des endpoints de recettes sur Heroku
# Ce script ajoute les endpoints de recettes à votre serveur existant

echo "🚀 Déploiement des endpoints de recettes sur Heroku..."

# 1. Cloner le repo Heroku
echo "📥 Clonage du repository Heroku..."
git clone https://git.heroku.com/gaby-backend-victor2024.git heroku-temp
cd heroku-temp

# 2. Ajouter les endpoints au server.js
echo "📝 Ajout des endpoints de recettes..."

# Créer un fichier temporaire avec les nouveaux endpoints
cat > recipe-endpoints-temp.js << 'EOF'
// 🍳 Endpoints pour la génération et reformulation de recettes
// Ajoutés automatiquement le $(date)
...
# 3. Insérer les endpoints dans server.js (avant la route par défaut)
echo "🔧 Modification du server.js..."
...
echo "   - GET  https://gaby-backend-victor2024-c7b0d533c9ca.herokuapp.com/test-recipe"
echo "   - POST https://gaby-backend-victor2024-c7b0d533c9ca.herokuapp.com/generate-recipe"
echo "   - POST https://gaby-backend-victor2024-c7b0d533c9ca.herokuapp.com/reformulate-recipe"
